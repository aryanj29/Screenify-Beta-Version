        ...
        if (!wasCleared) {
            ...
            chrome.notifications.create(
                'watt-site-notification', {
                    type: 'basic',
                    iconUrl: 'icons/Screenifylogo.png',
                    title: "Screenify",
...
function addListener() {
    ...
    chrome.runtime.setUninstallURL("https://docs.google.com/forms/d/e/1FAIpQLSeOIL6oc1fLFOCEpHSkbasGaMRmEz5o1DoJG1hkNwhPu2DVEA/viewform?usp=sf_link");
}
